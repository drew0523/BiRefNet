...
class Config():
    def __init__(self) -> None:
        ...
        self.sys_home_dir = [os.path.expanduser('~'), '/home/ksh/ick/train_biref'][1]   # Default, custom
        ...
        self.validation_set = {
            # 'DIS5K': ['DIS-VD', 'DIS-TE1', 'DIS-TE2', 'DIS-TE3', 'DIS-TE4'][0],
            # 'COD': ['CHAMELEON', 'NC4K', 'TE-CAMO', 'TE-COD10K'][0],
            # 'HRSOD': ['DAVIS-S', 'TE-HRSOD', 'TE-UHRSD', 'DUT-OMRON', 'TE-DUTS'][0],
            'custom': 'validate_custom',
            # 'General-2K': ['DIS-VD', 'TE-P3M-500-NP'][0],
            # 'Matting': ['TE-P3M-500-NP', 'TE-AM-2k'][0],
        }[self.task]
        ...
        self.freeze_bb = False   # backbone network encoder freeze 처리
        self.model = [
            'BiRefNet',
            'BiRefNetC2F',
        ][0]
        ...
        # Loss
        if self.task in ['Matting', 'custom']:
